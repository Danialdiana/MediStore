            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{route('preparats.index')}}">Главная страница</a>
                        </li>
                        @isset($categories)
                        @foreach($categories as $category)
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('preparats.category',$category->id)}}">{{$category->category}}</a>
                            </li>
                        @endforeach
                           @can('create',\App\Models\Preparat::class)
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('preparats.create')}}">Создать</a>
                                </li>
                            @endcan
                        @endisset
                    </ul>
